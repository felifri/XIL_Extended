...
parser.add_argument('-m', '--mode', default='RRR', type=str, choices=['Vanilla','RRR','RRR-G','HINT','CDEP','CE','RBR', 'HINT_IG', 'HINT_IG2',\
...
parser.add_argument('--hint_ig', default=50000, type=int)
